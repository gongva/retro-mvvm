...
public class MediaUtil {
    ...
    public static void openFile(Context context, String path) {
        ...
        if (!file.exists()) {
            Toast.makeText(context, "文件找不到，请重试", Toast.LENGTH_SHORT).show();
            return;
        }
        try {
            ...
            Toast.makeText(context, "文件不能打开，请下载相关软件！", Toast.LENGTH_SHORT).show();
        }
    }
     ...
     * @param filepath
     */
    public static void scanFile(Context context, MediaScannerConnection.OnScanCompletedListener listener, String... filepath) {
        if (filepath != null) {
            for (String path : filepath) {
                syncDestination(path);
            }
        }
        MediaScannerConnection.scanFile(context, filepath, null, listener);
    }

    public static void scanFile(Context context, String... filepath) {
        scanFile(context, null, filepath);
    }
    ...
    private static void syncDestination(String filepath) {
        ...
        try {
            ...
            LogCat.e("IOException trying to sync " + filepath + ": " + ex);
        } finally {
            if (outStream != null) {
                try {
                    outStream.close();
                } catch (Exception ex) {
                    LogCat.e("IOException while closing synced file: ", ex);
                }
            }
        }
    }
