package com.gongva.library.app.ui.view.scroll.detectedscroll;
...
/**
 * Desc: 可设置渐变View的GridView
 * Author: gongwei 2018/12/24
 */
public class DetectedGridView extends GridView {
    ...
    public DetectedGridView(Context context) {
        super(context);
        init();
    }

    public DetectedGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DetectedGridView(Context context, AttributeSet attrs, int defStyleAttr) {
