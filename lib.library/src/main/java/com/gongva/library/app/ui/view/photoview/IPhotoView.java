 ...
 *******************************************************************************/
package com.gongva.library.app.ui.view.photoview;
...
public interface IPhotoView {
    ...
    /**
     * Sets the Display Matrix of the currently displayed Drawable. The Rectangle is considered relative to this View
     * and includes all scaling and translations.
     *
    ...
    /**
     * Gets the Display Matrix of the currently displayed Drawable. The Rectangle is considered relative to this View
     * and includes all scaling and translations.
     *
     * @return - true if rectangle was applied successfully
     */
    ...
    /**
     * Return the current scale module in use by the ImageView.
     *
    ...
    /**
     * Whether to allow the ImageView's parent to intercept the touch event when the photo is scroll to it's horizontal
     * edge.
     *
    ...
    /*
     * Sets the medium scale level. What this value represents depends on the current {@url
    ...
    /**
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a single tap.
     *
     ...
     * happen within the confines of this {@link ImageView.ScaleType}.
     *
    ...
    /**
     * Extracts currently visible area to Bitmap object, if there is no image loaded yet or the ImageView is already
     * destroyed, returns {@code null}
     *
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (PhotoViewAttacher.DEFAULT_ZOOM_DURATION). Will
     * default to 200 if provided negative value
     *
    ...
    /**
     * Will return instance of IPhotoView (eg. PhotoViewAttacher), can be used to provide better integration
     *
    ...
    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to default, you can just
     * pass in "null" or public field of PhotoViewAttacher.defaultOnDoubleTapListener
     *
