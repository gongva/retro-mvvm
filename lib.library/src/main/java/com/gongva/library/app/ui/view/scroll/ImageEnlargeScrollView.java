package com.gongva.library.app.ui.view.scroll;
...
public class ImageEnlargeScrollView extends StretchScrollView {
    ...
    public void replyImage() {
        final FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) imageView
                .getLayoutParams();
        ...
        final float margin = ((FrameLayout.LayoutParams) imageView.getLayoutParams()).leftMargin;
        // 设置动画
